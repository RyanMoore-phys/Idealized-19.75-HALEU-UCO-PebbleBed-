...
Modeled 19.75% enriched HALEU UCO HTGR Pebble with roughly 13 thousand TRISO pellets, using OpenMC. Using idealized conditions (reflective boundary BC's &amp; cold temperature), this project determines Fresh-fuel k-inf, spectrum, and reaction rate ratios. The project also includes a 3 Year Burnup curve and Isotope Inventory. This project ultizies publically data on cross-sections and atomic properties, links found below. <br>
